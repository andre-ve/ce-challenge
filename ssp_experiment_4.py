...
for initial_bots_e, spawn_rate_e, o_penalty_e, bot_r_e in product(initial_bots_values, spawn_rate_values, o_penalty_values, bot_r_values):
    exp = Experiment(exp_id=i, logger=exp_logger, grid_size = 100, initial_bots = initial_bots_e, spawn_rate = spawn_rate_e, iterations = 1000, o_penalty = o_penalty_e, bot_r = bot_r_e)
    i += 1
    exp.run()